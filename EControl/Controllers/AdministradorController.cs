...
namespace EControl.Controllers
{
    public class AdministradorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome,Sexo,Nascimento,TelefoneCel,TelefoneRes,Email,Cargo")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,Sexo,Nascimento,TelefoneCel,TelefoneRes,Email,Cargo")] Administrador administrador)
        {
