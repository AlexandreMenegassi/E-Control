...
namespace EControl.Controllers
{
    public class ServicoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Valor,Custo,Desconto,TipoPag")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Valor,Custo,Desconto,TipoPag")] Servico servico)
        {
            if (id != servico.Id)
            {
                return NotFound();
